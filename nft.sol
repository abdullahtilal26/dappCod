...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 nftPerAddressLimitFreeO=3;//whitelist
  uint256 nftPerAddressLimitFreeL=2;
  uint256 nftPerAddressLimitO=3;
  uint256 nftPerAddressLimitL=3;
  uint256 nftPerAddressLimitFreePublic=1;
  uint256 nftPerAddressLimitPublic=3;
    ...
    if(onlyWhiteListed==true){
        ...
        if(isWhiteListedO(msg.sender)){
            ...
            if(_mintAmount<=freeMintAvailable){
                ...
                uint256 paidMint=_mintAmount-ownerTokenCountNewBalance;
            ...
            uint256 ownerTokenCount=balanceOf(msg.sender);
            require(ownerTokenCount<nftPerAddressLimitL);
             uint256 freeMintAvailable=nftPerAddressLimitFreeO-ownerTokenCount;
            if(_mintAmount<=freeMintAvailable){
